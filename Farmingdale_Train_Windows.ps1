...
python -m venv farmingdale-env

Write-Host "[*] Activating virtual environment..."
& .\farmingdale-env\Scripts\Activate.ps1
...
Write-Host "[*] Writing Python script..."
@'
...
# Bottom row frame for countdown and credit
bottom_frame = tk.Frame(root, bg="#f0f0f0")
bottom_frame.pack(fill="x", side="bottom", padx=15, pady=5)

countdown_label = tk.Label(bottom_frame, text="", font=("Helvetica", 12), bg="#f0f0f0", fg="#b0b0b0", anchor="w")
countdown_label.pack(side="left")

credit_label = tk.Label(bottom_frame, text="Made by Colby K", font=("Helvetica", 10), bg="#f0f0f0", fg="#a0a0a0", anchor="e")
...
countdown_timer()
root.mainloop()
'@ | Out-File -Encoding UTF8 .\farmingdale_live.py

Write-Host "[*] Launching Farmingdale Train Display..."
python .\farmingdale_live.py
